...
const CompanyCard: React.FC<CompanyCardProps> = ({ company, onEdit, onDelete }) => {
  return (
    <Card className="flex flex-col items-center justify-between p-4 border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200">
      ...
      <CardContent className="flex gap-2 mt-4">
        <Button
          ...
          className="flex items-center gap-1 text-sollux-black border-sollux-gray hover:bg-gray-100"
        >
