import { Home, ListChecks, ListTodo, Blocks, Scale, Target, Store, FileText, Tag, ClipboardCheck, Brain, ClipboardList, MessageSquareText, Award, TrendingUp, ShoppingBag, Lightbulb, Ruler, Repeat } from 'lucide-react';
...
export const routeMap: Record<string, RouteInfo> = {
  ...
  '/core/global-settings/ops/kpi-smart-frequencies': { name: 'OPS - Frequência de Monitoramento', parent: '/core/global-settings/ops', icon: Repeat }, // Nova rota
