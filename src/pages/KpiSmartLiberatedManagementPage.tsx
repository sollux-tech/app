...
const KpiSmartLiberatedManagementPage: React.FC = () => {
  ...
  const selectedPillarIdForKpiSmart = form.watch('pillar_id');
          ...
          if (error) {
            ...
            if (kpiDetails) {
              setSelectedKpiSmartDetails({
                ...
                kpi_smart_focus_id: kpiSmartLiberated.kpi_smart_focus_id || '', // Use value from editingKpiSmartLiberated if available
