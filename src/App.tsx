      ...
      <BrowserRouter>
        <SessionContextProvider>
          <Routes>
            ...
            <Route path="/id" element={<LayoutShell><div className="p-6 bg-white rounded-2xl shadow-lg"><h2>ID App Content</h2><p>This is a placeholder for the ID application.</p></div></LayoutShell>} />
